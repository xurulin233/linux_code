...
int main(int argc, char * const *argv) {
	...
	//char addr[16];
	const char *remote_addr = "localhost";
	...
	printf("Making %d connections to http://%s:%d%s %lu\n", num_conns, remote_addr, remote_port, uri, time(0));
...
num_conns = 1000;	
	...
	printf("All %d requests sent (%d connected). %lu\n", num_conns, connected, time(0));
